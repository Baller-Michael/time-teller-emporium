...
export const watches: Watch[] = [
  ...
  },
  {
    ...
    originalPrice: 2100,
    image: watch2,
    images: [watch2, watch1, watch4, watch6, watch3],
    category: "sport",
    isOnSale: true,
  ...
  },
  {
    ...
    price: 1950,
    image: watch3,
    images: [watch3, watch5, watch6, watch1, watch2],
    category: "dress",
  ...
  },
  {
    ...
    price: 3200,
    image: watch4,
    images: [watch4, watch2, watch1, watch5, watch6],
    category: "diving",
    isNew: true,
  ...
  },
  {
    ...
    price: 2750,
    image: watch5,
    images: [watch5, watch3, watch4, watch6, watch1],
    category: "pilot",
  ...
  },
  {
    ...
    originalPrice: 1450,
    image: watch6,
    images: [watch6, watch1, watch5, watch3, watch2],
    category: "minimalist",
    isOnSale: true,
